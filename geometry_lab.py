...
def translation(x,y):
    ...
    '''
    D = {'x','y','u'}
    return Mat((D, D), {('x','x'):1, ('y','y'):1, ('u','u'):1, ('x','u'):x , ('y','u'): y})
...
def scale(a, b):
    ...
    '''
    D = {'x','y','u'}
    return Mat((D, D), {('x','x'): a, ('y','y'): b, ('u','u'): 1})
...
def rotation(angle):
    ...
    '''
    D = {'x', 'y', 'u'}
    return Mat((D, D), {('x', 'x'): math.cos(angle), ('x', 'y'): -math.sin(angle),
...
def scale_color(scale_r,scale_g,scale_b):
    ...
    '''
    D = {'r', 'g', 'b'}
    return Mat((D, D), {('r','r'): scale_r, ('g','g'): scale_g, ('b','b'): scale_b})
...
def grayscale():
    ...
    '''
    D = {'r', 'g', 'b'}
    return Mat((D, D), {('r','r'): 77/256, ('r', 'g'): 151/256, ('r','b'): 28/256,
...
def reflect_about(p1,p2):
    ...
    return translation(mpx,mpy)*rotation(angle)*reflect_y()*rotation(angle)*translation(-mpx,-mpy)
